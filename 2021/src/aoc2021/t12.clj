...
(def short-example "resources/t12-short-example.txt")
(def example "resources/t12-example.txt")
(def example226 "resources/t12-226-example.txt")

(def path "resources/t12.txt")
